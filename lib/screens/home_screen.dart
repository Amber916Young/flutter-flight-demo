...
import 'package:flutter_hello_word/screens/hotel_screen.dart';
...
import 'package:flutter_hello_word/widgets/double_text_widget.dart';
      ...
      body: ListView(
        children: [
                ...
                Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text("Good moring", style: Styles.headLine3Style,),
                        const Gap(5),
          ...
          Container(
            ...
            child: const AppDoubleTextWidgets(
